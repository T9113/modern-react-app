...
const projects = [
  { src: '/images/projects/cp8.webp', name: 'Commercial Centre', location: 'Jacksonville, FL – USA' },
  { src: '/images/projects/cp10.webp', name: 'Office Complex', location: 'Orlando, FL – USA' },
  ...
  { src: '/images/projects/cp11.jpeg', name: 'FMCG Warehouse Al Ain - UAE', location: '' },
  { src: '/images/projects/cp12.jpeg', name: 'Port of Fujairah - UAE', location: '' },
];
