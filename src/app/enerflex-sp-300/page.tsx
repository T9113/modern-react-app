...
export default function SP300Page() {
 ...
 <div className="sp300-hero-image">
          <Image
            src="/images/slider/Banner-EnerFlex-SP-300.jpeg"
            alt="EnerFlex SP 300"
            width={1200}
            height={500}
      ...
      <div className="container page-container">
        ...
        <div className="product-full-image">
          <Image src="/images/products/sp300/content-image.webp" alt="EnerFlex SP 300 Application" width={1200} height={500} className="image-full-contain-20" />
        </div>
