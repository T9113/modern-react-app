...
export const ap250Docs: ProductDoc[] = [
  {
    ...
    alt: 'Flyer',
    label: 'Flyer',
    pdfUrl: '/pdfs/ap250/Enerthane-ap-250.pdf',
  },
  {
...
export const sp300Docs: ProductDoc[] = [
  ...
  },
  {
    ...
    alt: 'TDS',
    label: 'TDS',
    pdfUrl: '/pdfs/sp300/Technical-Data-Sheet-EnerFlex-SP-300.pdf',
  },
  {
...
// ---- EnerFlex SPX 300 -----------------------------------------
export const spx300Docs: ProductDoc[] = [
  {
    previewSrc: '/images/products/spx300/flyer-preview.webp',
    alt: 'Flyer',
    label: 'Flyer',
    pdfUrl: '/pdfs/spx300/Flyer-EnerFlex-SPX-300.pdf',
  },
  {
    previewSrc: '/images/products/spx300/tds-preview.webp',
    alt: 'TDS',
    label: 'TDS',
    pdfUrl: '/pdfs/spx300/Technical-Data-Sheet-EnerFlex-SPX-300.pdf',
  },
  {
    previewSrc: '/images/products/sp300/sds-preview.png',
    alt: 'SDS',
    label: 'SDS',
    pdfUrl: '/pdfs/spx300/MSDS-EnerFlex-SPX-300.pdf',
  },
];
